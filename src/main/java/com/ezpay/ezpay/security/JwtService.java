...
public class JwtService {
    ...
    @Value("${jwt.access-expiry-in-hours}")
    Integer minutes;
    ...
    public String generateToken(Map<String, Object> extraClaims, String email) {
        ...
        return Jwts
                ...
                .setExpiration(Date.from(issuedAt.plus(minutes, ChronoUnit.HOURS)))
    ...
    public String generateToken(User user) {
        ...
        extraClaims.put("profile_photo_url", user.getAvatarUrl());
        extraClaims.put("email", user.getUsername());
//        extraClaims.put("firstName", user.ge());
